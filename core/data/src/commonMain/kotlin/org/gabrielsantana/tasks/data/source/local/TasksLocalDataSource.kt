...
import org.gabrielsantana.tasks.data.getDeviceId
import kotlin.uuid.ExperimentalUuidApi
import kotlin.uuid.Uuid

internal class TasksLocalDataSource(private val db: TasksDatabase) {
    private val queries = db.taskQueries

    /**
     * Create and return [org.gabrielsantana.tasks.TaskEntity]
     */
    fun insert(
        title: String,
        description: String,
